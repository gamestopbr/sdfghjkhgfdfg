...
const developers = ['499286168819728404'];
const admin = "=";
const prefix = "+";
...
client.on('ready', () => {
  ...
  console.log('By : '+`${client.users.get("499286168819728404").username}`)
   client.user.setActivity("top bot| +help",{type: 'GameSTOP'})
   client.user.setStatus("افضل بوت عربي")
});
